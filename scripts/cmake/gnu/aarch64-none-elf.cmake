...
# Common Option
set(COMMON_ASFLAGS "-x assembler-with-cpp -march=${TARGET_ARCH} -mtune=${TARGET_CPU} -nostdinc -mgeneral-regs-only -mstrict-align -ffreestanding -Wa,--fatal-warnings -D__ASSEMBLER__ -I${CMAKE_SOURCE_DIR}/include/lib/arch/arm/aarch64")
set(COMMON_CFLAGS "-march=${TARGET_ARCH} -mtune=${TARGET_CPU} -nostdinc -mgeneral-regs-only -mstrict-align -ffunction-sections -fdata-sections -ffreestanding -fno-common -I${CMAKE_SOURCE_DIR}/include/lib/arch/arm/aarch64")
...
# Debug
set(CMAKE_ASM_FLAGS_DEBUG "${COMMON_ASFLAGS} -O0 -g -Wa,-gdwarf-4"  CACHE STRING "" FORCE)
set(CMAKE_C_FLAGS_DEBUG   "${COMMON_CFLAGS} -O0 -g -gdwarf-4"   CACHE STRING "" FORCE)
...
# MinSizeRel
set(CMAKE_ASM_FLAGS_MINSIZEREL "${COMMON_ASFLAGS} -Os -DNDEBUG"  CACHE STRING "" FORCE)
set(CMAKE_C_FLAGS_MINSIZEREL   "${COMMON_CFLAGS} -Os -DNDEBUG"   CACHE STRING "" FORCE)
...
# Release
set(CMAKE_ASM_FLAGS_RELEASE "${COMMON_ASFLAGS} -O2 -DNDEBUG"  CACHE STRING "" FORCE)
set(CMAKE_C_FLAGS_RELEASE   "${COMMON_CFLAGS} -O2 -DNDEBUG"   CACHE STRING "" FORCE)
...
# RelWithDebInfo
set(CMAKE_ASM_FLAGS_RELWITHDEBINFO "${COMMON_ASFLAGS} -O2 -g -DNDEBUG"  CACHE STRING "" FORCE)
set(CMAKE_C_FLAGS_RELWITHDEBINFO   "${COMMON_CFLAGS} -O2 -g -DNDEBUG"   CACHE STRING "" FORCE)
